...
{
    public static string Serialize<[Dam(Dat.PublicProperties)] T>(T value, DotEnvSerializerOptions? options = null)
        => Serializer.Serialize(value, typeof(T), options);

    public static void Serialize<[Dam(Dat.PublicProperties)] T>(Stream stream, T value, DotEnvSerializerOptions? options = null)
