...
{
    public static Delegate CreateDelegate(this PropertyInfo propertyInfo, bool createGetter)
    {
        return createGetter
    ...
    public static Delegate CreateDelegate(this FieldInfo fieldInfo, bool createGetter)
    {
        return createGetter
    ...
    /// <summary>
    /// Determines whether the specified type is primitive, including string.
    /// </summary>
